// =============================================================================
// modules/stress_test_quick.js — Inline Quick Run (13 Modules)
// =============================================================================
...
export const options = { stages: QUICK_STAGES, thresholds: THRESHOLDS };
...
export function setup() {
  ...
  console.log('[setup] Quick run — both logins successful.');
...
export function teardown() {
  console.log('[teardown] Quick run complete.');
}
